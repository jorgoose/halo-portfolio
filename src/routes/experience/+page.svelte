...
<RadioWidget
  audioSrc="/audio/experience_cortana_and_chief.mp3"
  initialSpeaker="chief"
  speakerTimings={[{time:0,speaker:'chief'},{time:5,speaker:'cortana'},{time:23,speaker:'chief'},{time:25,speaker:'cortana'},{time:32,speaker:'chief'}]}
  position="left"
  resetOnEnd={false}
/>
